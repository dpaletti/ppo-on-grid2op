...
if __name__ == "__main__":
    ...
    best_params = tune_topological_ppo(
        ...
        reward_class=reward,
        n_sampler_startup_trials=10,  # how many random trials to wait before starting the sampler
        min_timesteps_before_pruning=1000,  # how many timesteps to wait before evaluating to prune
